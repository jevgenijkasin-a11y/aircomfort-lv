"use strict";(()=>{var e={};e.id=6717,e.ids=[6717],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},57147:e=>{e.exports=require("fs")},55467:e=>{e.exports=require("node:sqlite")},71017:e=>{e.exports=require("path")},28722:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>d,patchFetch:()=>m,requestAsyncStorage:()=>p,routeModule:()=>c,serverHooks:()=>L,staticGenerationAsyncStorage:()=>u});var a={};r.r(a),r.d(a,{GET:()=>l,dynamic:()=>E});var n=r(49303),i=r(88716),o=r(60670),s=r(35168),T=r(20442);let E="force-dynamic";async function l(){let e=await Promise.all(T.nq.map(async e=>{let t=await (0,T.Kw)(e);return{loc:`${s._}/sitemaps/${e}.xml`,lastmod:t.map(e=>e.lastmod).sort().at(-1)}}));return new Response((0,T.Gk)(e),{headers:T.AO})}let c=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"route",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"C:\\Users\\Jevgenij\\Documents\\Projects\\aircomfort-lv\\src\\app\\sitemap.xml\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:p,staticGenerationAsyncStorage:u,serverHooks:L}=c,d="/sitemap.xml/route";function m(){return(0,o.patchFetch)({serverHooks:L,staticGenerationAsyncStorage:u})}},49303:(e,t,r)=>{e.exports=r(30517)},25866:(e,t,r)=>{r.d(t,{Cz:()=>a,IL:()=>i,pP:()=>n});let a=24,n={"1719d7c0-0070-473d-907f-7e7d542eafba":"76662679-b614-4719-a279-49bb3f67acc8"},i=e=>e.filter(e=>!n[e.id])},75748:(e,t,r)=>{r.d(t,{G$:()=>g,GK:()=>Y,GL:()=>F,Gw:()=>D,Ir:()=>h,LH:()=>G,MF:()=>l,OV:()=>j,RN:()=>I,Rf:()=>b,Vr:()=>x,Wv:()=>v,XU:()=>$,Y6:()=>B,c0:()=>X,db:()=>u,f1:()=>W,f5:()=>q,fd:()=>C,g8:()=>w,i0:()=>M,jd:()=>S,my:()=>P,nM:()=>y,rE:()=>k,ry:()=>R,sJ:()=>H,tr:()=>O,vb:()=>K,wv:()=>A});var a=r(55467),n=r(71017),i=r.n(n),o=r(57147),s=r.n(o),T=r(6113);let E=process.env.DATA_DIR||i().join(process.cwd(),"data"),l=i().join(E,"uploads"),c=`
...
`}let d={"Content-Type":"application/xml; charset=utf-8","Cache-Control":"public, max-age=3600"}}};var t=require("../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[8948,9551],()=>r(28722));module.exports=a})();