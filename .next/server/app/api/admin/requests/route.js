"use strict";(()=>{var e={};e.id=1387,e.ids=[1387],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},57147:e=>{e.exports=require("fs")},55467:e=>{e.exports=require("node:sqlite")},71017:e=>{e.exports=require("path")},8762:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>A,patchFetch:()=>O,requestAsyncStorage:()=>d,routeModule:()=>N,serverHooks:()=>U,staticGenerationAsyncStorage:()=>_});var n={};r.r(n),r.d(n,{DELETE:()=>L,GET:()=>p,PATCH:()=>l,dynamic:()=>u});var i=r(49303),s=r(88716),a=r(60670),T=r(87070),E=r(53930),o=r(75748);let u="force-dynamic";function c(){return T.NextResponse.json({error:"Unauthorized"},{status:401})}async function p(e){return await (0,E.Jg)(e)?T.NextResponse.json(await (0,o.fd)()):c()}async function l(e){if(!await (0,E.Jg)(e))return c();let{id:t,status:r}=await e.json();return await (0,o.my)(Number(t),r||"read"),T.NextResponse.json({success:!0})}async function L(e){if(!await (0,E.Jg)(e))return c();let{id:t}=await e.json();return await (0,o.GK)(Number(t)),T.NextResponse.json({success:!0})}let N=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/admin/requests/route",pathname:"/api/admin/requests",filename:"route",bundlePath:"app/api/admin/requests/route"},resolvedPagePath:"C:\\Users\\Jevgenij\\Documents\\Projects\\aircomfort-lv\\src\\app\\api\\admin\\requests\\route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:d,staticGenerationAsyncStorage:_,serverHooks:U}=N,A="/api/admin/requests/route";function O(){return(0,a.patchFetch)({serverHooks:U,staticGenerationAsyncStorage:_})}},53930:(e,t,r)=>{r.d(t,{Cp:()=>l,Jg:()=>u,VP:()=>s,kS:()=>p,x4:()=>c});var n=r(6113),i=r(75748);let s="admin_token";function a(e){let t=(0,n.randomBytes)(16).toString("hex"),r=(0,n.scryptSync)(e,t,64).toString("hex");return`scrypt$${t}$${r}`}function T(e,t){let[r,i,s]=t.split("$");if("scrypt"!==r||!i||!s)return!1;let a=(0,n.scryptSync)(e,i,64),T=Buffer.from(s,"hex");return a.length===T.length&&(0,n.timingSafeEqual)(a,T)}function E(){let e=(0,i.Y6)("password_hash");if(e)return e;if(process.env.ADMIN_PASSWORD){let e=a(process.env.ADMIN_PASSWORD);return(0,i.vb)("password_hash",e),e}return null}function o(e){return(0,n.createHmac)("sha256",function(){if(process.env.ADMIN_SECRET)return process.env.ADMIN_SECRET;let e=(0,i.Y6)("session_secret");return e||(e=(0,n.randomBytes)(32).toString("hex"),(0,i.vb)("session_secret",e)),e}()).update(e).digest("hex")}async function u(e){let t=e.cookies.get(s)?.value;if(!t||t.length<10)return!1;let r=E();return!!r&&t===o(r)}async function c(e){let t=E();return t&&e&&T(e,t)?o(t):null}async function p(){}async function l(e,t){let r=E();return!!(r&&T(e,r))&&((0,i.vb)("password_hash",a(t)),!0)}},75748:(e,t,r)=>{r.d(t,{G$:()=>y,GK:()=>H,GL:()=>h,Gw:()=>v,Ir:()=>S,LH:()=>G,MF:()=>u,OV:()=>$,RN:()=>I,Rf:()=>b,Vr:()=>M,Wv:()=>F,XU:()=>x,Y6:()=>q,c0:()=>X,db:()=>l,f1:()=>B,f5:()=>W,fd:()=>k,g8:()=>C,i0:()=>w,jd:()=>g,my:()=>Y,nM:()=>D,rE:()=>P,ry:()=>m,sJ:()=>j,tr:()=>R,vb:()=>J,wv:()=>f});var n=r(55467),i=r(71017),s=r.n(i),a=r(57147),T=r.n(a),E=r(6113);let o=process.env.DATA_DIR||s().join(process.cwd(),"data"),u=s().join(o,"uploads"),c=`
