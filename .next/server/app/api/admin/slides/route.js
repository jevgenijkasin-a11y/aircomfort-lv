"use strict";(()=>{var e={};e.id=130,e.ids=[130],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},57147:e=>{e.exports=require("fs")},55467:e=>{e.exports=require("node:sqlite")},71017:e=>{e.exports=require("path")},14456:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>U,patchFetch:()=>A,requestAsyncStorage:()=>N,routeModule:()=>L,serverHooks:()=>_,staticGenerationAsyncStorage:()=>d});var n={};r.r(n),r.d(n,{GET:()=>l,POST:()=>p,dynamic:()=>u});var i=r(49303),s=r(88716),a=r(60670),T=r(87070),o=r(53930),E=r(75748);let u="force-dynamic";function c(){return T.NextResponse.json({error:"Unauthorized"},{status:401})}async function l(e){return await (0,o.Jg)(e)?T.NextResponse.json(await (0,E.jd)()):c()}async function p(e){if(!await (0,o.Jg)(e))return c();let{image_url:t}=await e.json();if(!t)return T.NextResponse.json({error:"image_url required"},{status:400});let r=await (0,E.jd)(),n=r.length>0?Math.max(...r.map(e=>e.sort_order)):-1;return await (0,E.RN)(t,n+1),T.NextResponse.json({success:!0})}let L=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/admin/slides/route",pathname:"/api/admin/slides",filename:"route",bundlePath:"app/api/admin/slides/route"},resolvedPagePath:"C:\\Users\\Jevgenij\\Documents\\Projects\\aircomfort-lv\\src\\app\\api\\admin\\slides\\route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:N,staticGenerationAsyncStorage:d,serverHooks:_}=L,U="/api/admin/slides/route";function A(){return(0,a.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:d})}},53930:(e,t,r)=>{r.d(t,{Cp:()=>p,Jg:()=>u,VP:()=>s,kS:()=>l,x4:()=>c});var n=r(6113),i=r(75748);let s="admin_token";function a(e){let t=(0,n.randomBytes)(16).toString("hex"),r=(0,n.scryptSync)(e,t,64).toString("hex");return`scrypt$${t}$${r}`}function T(e,t){let[r,i,s]=t.split("$");if("scrypt"!==r||!i||!s)return!1;let a=(0,n.scryptSync)(e,i,64),T=Buffer.from(s,"hex");return a.length===T.length&&(0,n.timingSafeEqual)(a,T)}function o(){let e=(0,i.Y6)("password_hash");if(e)return e;if(process.env.ADMIN_PASSWORD){let e=a(process.env.ADMIN_PASSWORD);return(0,i.vb)("password_hash",e),e}return null}function E(e){return(0,n.createHmac)("sha256",function(){if(process.env.ADMIN_SECRET)return process.env.ADMIN_SECRET;let e=(0,i.Y6)("session_secret");return e||(e=(0,n.randomBytes)(32).toString("hex"),(0,i.vb)("session_secret",e)),e}()).update(e).digest("hex")}async function u(e){let t=e.cookies.get(s)?.value;if(!t||t.length<10)return!1;let r=o();return!!r&&t===E(r)}async function c(e){let t=o();return t&&e&&T(e,t)?E(t):null}async function l(){}async function p(e,t){let r=o();return!!(r&&T(e,r))&&((0,i.vb)("password_hash",a(t)),!0)}},75748:(e,t,r)=>{r.d(t,{G$:()=>y,GK:()=>H,GL:()=>F,Gw:()=>v,Ir:()=>S,LH:()=>G,MF:()=>u,OV:()=>$,RN:()=>I,Rf:()=>x,Vr:()=>M,Wv:()=>h,XU:()=>b,Y6:()=>q,c0:()=>X,db:()=>p,f1:()=>B,f5:()=>W,fd:()=>k,g8:()=>C,i0:()=>w,jd:()=>g,my:()=>Y,nM:()=>D,rE:()=>P,ry:()=>m,sJ:()=>j,tr:()=>R,vb:()=>V,wv:()=>f});var n=r(55467),i=r(71017),s=r.n(i),a=r(57147),T=r.n(a),o=r(6113);let E=process.env.DATA_DIR||s().join(process.cwd(),"data"),u=s().join(E,"uploads"),c=`
