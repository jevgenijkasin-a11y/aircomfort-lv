"use strict";(()=>{var e={};e.id=5333,e.ids=[5333],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},57147:e=>{e.exports=require("fs")},55467:e=>{e.exports=require("node:sqlite")},71017:e=>{e.exports=require("path")},38623:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>_,patchFetch:()=>U,requestAsyncStorage:()=>L,routeModule:()=>l,serverHooks:()=>d,staticGenerationAsyncStorage:()=>N});var n={};r.r(n),r.d(n,{GET:()=>u,POST:()=>p,dynamic:()=>c});var i=r(49303),a=r(88716),s=r(60670),T=r(87070),o=r(53930),E=r(75748);let c="force-dynamic";async function u(e){return await (0,o.Jg)(e)?T.NextResponse.json(await (0,E.sJ)()):T.NextResponse.json({error:"Unauthorized"},{status:401})}async function p(e){if(!await (0,o.Jg)(e))return T.NextResponse.json({error:"Unauthorized"},{status:401});let t=await e.json();try{await (0,E.LH)(t)}catch(e){return T.NextResponse.json({error:e.message},{status:500})}return T.NextResponse.json({ok:!0})}let l=new i.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/admin/cards/route",pathname:"/api/admin/cards",filename:"route",bundlePath:"app/api/admin/cards/route"},resolvedPagePath:"C:\\Users\\Jevgenij\\Documents\\Projects\\aircomfort-lv\\src\\app\\api\\admin\\cards\\route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:L,staticGenerationAsyncStorage:N,serverHooks:d}=l,_="/api/admin/cards/route";function U(){return(0,s.patchFetch)({serverHooks:d,staticGenerationAsyncStorage:N})}},53930:(e,t,r)=>{r.d(t,{Cp:()=>l,Jg:()=>c,VP:()=>a,kS:()=>p,x4:()=>u});var n=r(6113),i=r(75748);let a="admin_token";function s(e){let t=(0,n.randomBytes)(16).toString("hex"),r=(0,n.scryptSync)(e,t,64).toString("hex");return`scrypt$${t}$${r}`}function T(e,t){let[r,i,a]=t.split("$");if("scrypt"!==r||!i||!a)return!1;let s=(0,n.scryptSync)(e,i,64),T=Buffer.from(a,"hex");return s.length===T.length&&(0,n.timingSafeEqual)(s,T)}function o(){let e=(0,i.Y6)("password_hash");if(e)return e;if(process.env.ADMIN_PASSWORD){let e=s(process.env.ADMIN_PASSWORD);return(0,i.vb)("password_hash",e),e}return null}function E(e){return(0,n.createHmac)("sha256",function(){if(process.env.ADMIN_SECRET)return process.env.ADMIN_SECRET;let e=(0,i.Y6)("session_secret");return e||(e=(0,n.randomBytes)(32).toString("hex"),(0,i.vb)("session_secret",e)),e}()).update(e).digest("hex")}async function c(e){let t=e.cookies.get(a)?.value;if(!t||t.length<10)return!1;let r=o();return!!r&&t===E(r)}async function u(e){let t=o();return t&&e&&T(e,t)?E(t):null}async function p(){}async function l(e,t){let r=o();return!!(r&&T(e,r))&&((0,i.vb)("password_hash",s(t)),!0)}},75748:(e,t,r)=>{r.d(t,{G$:()=>y,GK:()=>H,GL:()=>F,Gw:()=>v,Ir:()=>S,LH:()=>G,MF:()=>c,OV:()=>$,RN:()=>I,Rf:()=>x,Vr:()=>M,Wv:()=>h,XU:()=>b,Y6:()=>q,c0:()=>X,db:()=>l,f1:()=>B,f5:()=>W,fd:()=>k,g8:()=>C,i0:()=>w,jd:()=>g,my:()=>Y,nM:()=>D,rE:()=>P,ry:()=>m,sJ:()=>j,tr:()=>R,vb:()=>J,wv:()=>f});var n=r(55467),i=r(71017),a=r.n(i),s=r(57147),T=r.n(s),o=r(6113);let E=process.env.DATA_DIR||a().join(process.cwd(),"data"),c=a().join(E,"uploads"),u=`
