"use strict";(()=>{var e={};e.id=2577,e.ids=[2577],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},57147:e=>{e.exports=require("fs")},55467:e=>{e.exports=require("node:sqlite")},71017:e=>{e.exports=require("path")},27287:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>U,patchFetch:()=>A,requestAsyncStorage:()=>N,routeModule:()=>L,serverHooks:()=>_,staticGenerationAsyncStorage:()=>d});var n={};r.r(n),r.d(n,{GET:()=>p,POST:()=>l,dynamic:()=>u});var i=r(49303),a=r(88716),s=r(60670),T=r(87070),o=r(53930),E=r(75748);let u="force-dynamic";function c(){return T.NextResponse.json({error:"Unauthorized"},{status:401})}async function p(e){return await (0,o.Jg)(e)?T.NextResponse.json(await (0,E.tr)()):c()}async function l(e){if(!await (0,o.Jg)(e))return c();let t=await e.json(),r=await (0,E.ry)(t);return T.NextResponse.json(r)}let L=new i.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/admin/products/route",pathname:"/api/admin/products",filename:"route",bundlePath:"app/api/admin/products/route"},resolvedPagePath:"C:\\Users\\Jevgenij\\Documents\\Projects\\aircomfort-lv\\src\\app\\api\\admin\\products\\route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:N,staticGenerationAsyncStorage:d,serverHooks:_}=L,U="/api/admin/products/route";function A(){return(0,s.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:d})}},53930:(e,t,r)=>{r.d(t,{Cp:()=>l,Jg:()=>u,VP:()=>a,kS:()=>p,x4:()=>c});var n=r(6113),i=r(75748);let a="admin_token";function s(e){let t=(0,n.randomBytes)(16).toString("hex"),r=(0,n.scryptSync)(e,t,64).toString("hex");return`scrypt$${t}$${r}`}function T(e,t){let[r,i,a]=t.split("$");if("scrypt"!==r||!i||!a)return!1;let s=(0,n.scryptSync)(e,i,64),T=Buffer.from(a,"hex");return s.length===T.length&&(0,n.timingSafeEqual)(s,T)}function o(){let e=(0,i.Y6)("password_hash");if(e)return e;if(process.env.ADMIN_PASSWORD){let e=s(process.env.ADMIN_PASSWORD);return(0,i.vb)("password_hash",e),e}return null}function E(e){return(0,n.createHmac)("sha256",function(){if(process.env.ADMIN_SECRET)return process.env.ADMIN_SECRET;let e=(0,i.Y6)("session_secret");return e||(e=(0,n.randomBytes)(32).toString("hex"),(0,i.vb)("session_secret",e)),e}()).update(e).digest("hex")}async function u(e){let t=e.cookies.get(a)?.value;if(!t||t.length<10)return!1;let r=o();return!!r&&t===E(r)}async function c(e){let t=o();return t&&e&&T(e,t)?E(t):null}async function p(){}async function l(e,t){let r=o();return!!(r&&T(e,r))&&((0,i.vb)("password_hash",s(t)),!0)}},75748:(e,t,r)=>{r.d(t,{G$:()=>y,GK:()=>H,GL:()=>h,Gw:()=>v,Ir:()=>S,LH:()=>G,MF:()=>u,OV:()=>$,RN:()=>I,Rf:()=>b,Vr:()=>M,Wv:()=>F,XU:()=>x,Y6:()=>q,c0:()=>X,db:()=>l,f1:()=>B,f5:()=>j,fd:()=>k,g8:()=>C,i0:()=>w,jd:()=>g,my:()=>Y,nM:()=>D,rE:()=>P,ry:()=>m,sJ:()=>W,tr:()=>R,vb:()=>V,wv:()=>f});var n=r(55467),i=r(71017),a=r.n(i),s=r(57147),T=r.n(s),o=r(6113);let E=process.env.DATA_DIR||a().join(process.cwd(),"data"),u=a().join(E,"uploads"),c=`
