...
export const T = {
  ru: {
    ...
    revEdit: 'Редактировать',
    revDelete: 'Удалить',
    revDeleteConfirm: 'Удалить этот отзыв?',
    revSave: 'Сохранить',
    revCancel: 'Отмена',
    revAddTitle: 'Новый отзыв',
    revEditTitle: 'Редактировать отзыв',
    revAuthor: 'Имя автора',
    revTextRu: 'Текст (RU)',
    revTextLv: 'Текст (LV)',
    revTextEn: 'Текст (EN)',
    revRating: 'Рейтинг (1–5)',
    revVisible: 'Показывать на сайте',
    revEmpty: 'Отзывов пока нет',
    revEmptyDesc: 'Добавьте первый отзыв',
    navSlider: 'Слайдер',
    sliderTitle: 'Фото слайдера',
    sliderDesc: 'Фотографии на главной странице сайта',
    sliderUpload: 'Загрузить фото',
    sliderUploading: 'Загрузка...',
    sliderEmpty: 'Фотографий нет',
    sliderEmptyDesc: 'Загрузите первое фото для слайдера',
    sliderVisible: 'Показывается',
    sliderHidden: 'Скрыто',
    sliderHide: 'Скрыть',
    sliderShow: 'Показать',
    sliderDelete: 'Удалить',
    sliderDeleteConfirm: 'Удалить это фото?',
    sliderMoveUp: 'Переместить вверх',
    sliderMoveDown: 'Переместить вниз',
  ...
  en: {
    ...
    revEdit: 'Edit',
    revDelete: 'Delete',
    revDeleteConfirm: 'Delete this review?',
    revSave: 'Save',
    revCancel: 'Cancel',
    revAddTitle: 'New Review',
    revEditTitle: 'Edit Review',
    revAuthor: 'Author Name',
    revTextRu: 'Text (RU)',
    revTextLv: 'Text (LV)',
    revTextEn: 'Text (EN)',
    revRating: 'Rating (1–5)',
    revVisible: 'Show on website',
    revEmpty: 'No reviews yet',
    revEmptyDesc: 'Add the first review',
    navSlider: 'Slider',
    sliderTitle: 'Hero Slider Photos',
    sliderDesc: 'Photos displayed on the home page background',
    sliderUpload: 'Upload Photo',
    sliderUploading: 'Uploading...',
    sliderEmpty: 'No photos yet',
    sliderEmptyDesc: 'Upload the first photo for the slider',
    sliderVisible: 'Visible',
    sliderHidden: 'Hidden',
    sliderHide: 'Hide',
    sliderShow: 'Show',
    sliderDelete: 'Delete',
    sliderDeleteConfirm: 'Delete this photo?',
    sliderMoveUp: 'Move up',
    sliderMoveDown: 'Move down',
